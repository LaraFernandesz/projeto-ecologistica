...
public class Menu {
    ...
    public void exibir() {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 5:
                    ConsoleIO.aviso("Sistema encerrado.");
                    break;

                default:
                    ConsoleIO.erro("Opção inválida.");
            }
    ...
    private void executarRoteamento() {
        ...
        try {
            ...
            ConsoleIO.sucesso("Algoritmo executado.");
    ...
    private void mostrarRelatorios() {
        ...
        System.out.println("Total de entregas: " + database.getEntregas().size());
        System.out.println("Total de rotas: " + database.getRotas().size());
    }
}